...
<<<<<<< HEAD
export type Props<DataPointType = any, DataValueType = any> = Omit<PresentationAttributesAdaptChildEvent<TickItem, SVGTextElement>, 'scale' | 'ref' | 'height'> & XAxisProps<DataPointType, DataValueType>;
=======
...
<<<<<<< HEAD
    readonly height: import("../state/cartesianAxisSlice").XAxisHeight;
=======
