...
<<<<<<< HEAD
var _XAxisUtils = require("../util/XAxisUtils");
=======
>>>>>>> 1b088f866b1dd5ae1736967832b5f824858cac95
...
<<<<<<< HEAD
   ...
   */
  var lastDispatchedTicksRef = (0, _react.useRef)(null);
  (0, _react.useEffect)(() => {
...
<<<<<<< HEAD
    ...
    if (last != null && last.axisId === axisId && last.axisType === axisType && (0, _isEqual.default)(last.ticks, tickItems)) {
      return;
    }
...
<<<<<<< HEAD
    ...
    getCalculatedHeight: () => {
      ...
      return (0, _XAxisUtils.getCalculatedXAxisHeight)({
        ticks: tickRefs.current,
