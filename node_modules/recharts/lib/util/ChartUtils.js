...
<<<<<<< HEAD
    ...
    if (position != null) {
      ...
      if ((0, _getCartesianPosition.isOutsidePosition)(position)) {
        if (position === 'top' && (0, _DataUtils.isNumber)(offset.top)) {
          return _objectSpread(_objectSpread({}, offset), {}, {
            top: offset.top + (boxHeight || 0) + legendOffset
          });
        }
        if (position === 'bottom' && (0, _DataUtils.isNumber)(offset.bottom)) {
          return _objectSpread(_objectSpread({}, offset), {}, {
            bottom: offset.bottom + (boxHeight || 0) + legendOffset
          });
        }
        if (position === 'left' && (0, _DataUtils.isNumber)(offset.left)) {
          return _objectSpread(_objectSpread({}, offset), {}, {
            left: offset.left + (boxWidth || 0) + legendOffset
          });
        }
        if (position === 'right' && (0, _DataUtils.isNumber)(offset.right)) {
          return _objectSpread(_objectSpread({}, offset), {}, {
