...
<<<<<<< HEAD
type IgnoredPaths = readonly (string | RegExp)[];
/**
 * @public
 */
declare function findNonSerializableValue(value: unknown, path?: string, isSerializable?: (value: unknown) => boolean, getEntries?: (value: unknown) => [string, any][], ignoredPaths?: IgnoredPaths, cache?: WeakSet<object>): NonSerializableValue | false;
=======
...
<<<<<<< HEAD
    <MatchFunctionType extends MatchFunction<Action>>(options: {
=======
