...
import {
  require_react_dom
} from "./chunk-7CY64OIN.js";
import {
  require_jsx_runtime
} from "./chunk-V4JYOG67.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-6RHENCWC.js";
import {
  require_react
} from "./chunk-OFR5Z5JI.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
  __toESM
} from "./chunk-VJPWYQ4R.js";
...
__name5(useCallbackRef, "useCallbackRef");
...
var DismissableLayer = React5.forwardRef(
  ...
  __name6(function DismissableLayer2(props, forwardedRef) {
    const {
    ...
    const pointerDownOutside = usePointerDownOutside(
      ...
      },
      {
        ...
        shouldHandlePointerDownOutside: React5.useCallback(
          (target) => {
    ...
    React5.useEffect(() => {
      const handleUpdate = __name6(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React5.forwardRef(__name6(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React5.useContext(DismissableLayerContext);
...
__name6(useDismissableLayerSurface, "useDismissableLayerSurface");
var IS_TRUE = __name6(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  React5.useEffect(() => {
    ...
    __name6(resetOutsideInteraction, "resetOutsideInteraction");
    function isOutsideInteractionIntercepted() {
      return Array.from(interceptedOutsideInteractionEventsRef.current.values()).some(Boolean);
    }
    __name6(isOutsideInteractionIntercepted, "isOutsideInteractionIntercepted");
    ...
    __name6(handleInteractionCapture, "handleInteractionCapture");
    function handleInteractionBubble(event) {
      if (isPointerDownOutsideRef.current) {
        interceptedOutsideInteractionEventsRef.current.set(event.type, false);
      }
    }
    __name6(handleInteractionBubble, "handleInteractionBubble");
    const handlePointerDown = __name6((event) => {
      if (event.target && !isPointerInsideReactTreeRef.current) {
        ...
        __name6(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
  ...
  return {
    ...
    onPointerDownCapture: __name6(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
__name6(usePointerDownOutside, "usePointerDownOutside");
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  const handleFocusOutside = useCallbackRef(onFocusOutside);
  const isFocusInsideReactTreeRef = React5.useRef(false);
  React5.useEffect(() => {
    const handleFocus = __name6((event) => {
  ...
  return {
    onFocusCapture: __name6(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name6(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
__name6(useFocusOutside, "useFocusOutside");
function dispatchUpdate() {
  const event = new CustomEvent(CONTEXT_UPDATE);
  document.dispatchEvent(event);
}
__name6(dispatchUpdate, "dispatchUpdate");
...
__name6(handleAndDispatchCustomEvent, "handleAndDispatchCustomEvent");
...
var Portal = React7.forwardRef(
  __name7(function Portal2(props, forwardedRef) {
    var _a2;
    const { container: containerProp, ...portalProps } = props;
    const [mounted, setMounted] = React7.useState(false);
    useLayoutEffect2(() => setMounted(true), []);
    const container = containerProp || mounted && ((_a2 = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a2.body);
    return container ? ReactDOM2.createPortal((0, import_jsx_runtime6.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
  }, "Portal")
);
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name8((event) => {
      ...
      const handleAnimationStart = __name8((event) => {
...
__name8(usePresence, "usePresence");
...
__name8(getElementRef, "getElementRef");
...
__name9(useEffectEvent, "useEffectEvent");
...
__name10(useControllableState, "useControllableState");
...
__name10(useUncontrolledState, "useUncontrolledState");
...
__name10(useControllableStateReducer, "useControllableStateReducer");
...
var VisuallyHidden = React11.forwardRef(
  __name11(function VisuallyHidden2(props, forwardedRef) {
...
var ToastProvider = __name12((props) => {
  const {
    __scopeToast,
    label = "Notification",
    duration = 5e3,
...
var ToastViewport = React12.forwardRef(
  __name12(function ToastViewport2(props, forwardedRef) {
    const {
      __scopeToast,
    ...
    React12.useEffect(() => {
      const handleKeyDown = __name12((event) => {
        var _a2;
    ...
    React12.useEffect(() => {
      ...
      if (hasToasts && wrapper && viewport) {
        ...
        const handleFocusOutResume = __name12((event) => {
          const isFocusMovingOutside = !wrapper.contains(event.relatedTarget);
          if (isFocusMovingOutside)
            handleResume();
        }, "handleFocusOutResume");
        const handlePointerLeaveResume = __name12(() => {
...
var FocusProxy = React12.forwardRef(
  // blank line to reduce diff noise
  __name12(function ToastFocusProxy(props, forwardedRef) {
...
var Toast = React12.forwardRef(
  // blank line to reduce diff noise
  __name12(function Toast2(props, forwardedRef) {
...
var ToastImpl = React12.forwardRef(
  __name12(function ToastImpl2(props, forwardedRef) {
    const {
      __scopeToast,
      type = "foreground",
    ...
    return (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      ...
      (0, import_jsx_runtime8.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM3.createPortal(
...
var ToastAnnounce = __name12((props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime8.jsx)(Portal, { asChild: true, container: context.announcerContainer || void 0, children: (0, import_jsx_runtime8.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React12.forwardRef(
  __name12(function ToastTitle2(props, forwardedRef) {
...
var ToastDescription = React12.forwardRef(
  // blank line to reduce diff noise
  __name12(function ToastDescription2(props, forwardedRef) {
...
var ToastAction = React12.forwardRef(
  __name12(function ToastAction2(props, forwardedRef) {
...
var ToastClose = React12.forwardRef(
  __name12(function ToastClose2(props, forwardedRef) {
...
var ToastAnnounceExclude = React12.forwardRef(__name12(function ToastAnnounceExclude2(props, forwardedRef) {
...
__name12(getAnnounceTextContent, "getAnnounceTextContent");
...
__name12(handleAndDispatchCustomEvent2, "handleAndDispatchCustomEvent");
var isDeltaInDirection = __name12((delta, direction, threshold = 0) => {
...
__name12(useNextFrame, "useNextFrame");
function isHTMLElement(node) {
  return node.nodeType === node.ELEMENT_NODE;
}
__name12(isHTMLElement, "isHTMLElement");
function getTabbableCandidates(container) {
  const nodes = [];
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: __name12((node) => {
