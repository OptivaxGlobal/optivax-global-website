...
<<<<<<< HEAD
type WritableDraft<T> = T extends any[] ? number extends T["length"] ? IsPlainArray<T> extends true ? Draft<T[number]>[] : WritableNonArrayDraft<T> : WritableNonArrayDraft<T> : WritableNonArrayDraft<T>;
/**
...
declare function original<T>(value: Draft<T>): T;
=======
...
<<<<<<< HEAD
declare function current<T>(value: Draft<T>): T;
=======
