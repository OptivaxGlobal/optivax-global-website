...
<<<<<<< HEAD
        ...
        const exportNameNode = stringSpecifiers.has(exportName) || computed ? _core.types.stringLiteral(exportName) : _core.types.identifier(exportName);
        const exportValue = exportValues[i];
        objectProperties.push(_core.types.objectProperty(exportNameNode, exportValue, computed));
=======
        const exportValue = exportValues[i];
...
<<<<<<< HEAD
    statements.push(_core.types.variableDeclaration("var", [_core.types.variableDeclarator(_core.types.identifier(exportObj), _core.types.objectExpression([_core.types.objectProperty(_core.types.identifier(protoKey), _core.types.nullLiteral())]))]));
=======
...
<<<<<<< HEAD
      ...
      const exportNameNode = computed ? _core.types.stringLiteral(exportName) : _core.types.identifier(exportName);
      const exportValue = exportValues[i];
      statements.push(_core.types.expressionStatement(_core.types.assignmentExpression("=", _core.types.memberExpression(_core.types.identifier(exportObj), exportNameNode, computed), exportValue)));
=======
      const exportValue = exportValues[i];
