...
<<<<<<< HEAD
declare const MenubarMenu: (props: ScopedProps<MenubarMenuProps>) => react_jsx_runtime.JSX.Element;
=======
...
<<<<<<< HEAD
declare const Menu: (props: ScopedProps<MenubarMenuProps>) => react_jsx_runtime.JSX.Element;
=======
declare const Menu: {
    (props: ScopedProps<MenubarMenuProps>): react_jsx_runtime.JSX.Element;
    displayName: string;
