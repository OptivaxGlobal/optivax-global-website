 ...
 */
<<<<<<< HEAD
declare function weakMapMemoize<Func extends AnyFunction>(func: Func, options?: WeakMapMemoizeOptions<ReturnType<Func>>): Func & Simplify<DefaultMemoizeFields>;
=======
 ...
 */
<<<<<<< HEAD
declare function autotrackMemoize<Func extends AnyFunction>(func: Func): Func & Simplify<DefaultMemoizeFields>;
=======
 ...
 */
<<<<<<< HEAD
declare function lruMemoize<Func extends AnyFunction>(func: Func, equalityCheckOrOptions?: EqualityFn | LruMemoizeOptions<ReturnType<Func>>): Func & Simplify<DefaultMemoizeFields>;

export { type Combiner, type CreateSelectorFunction, type CreateSelectorOptions, type DefaultMemoizeFields, type DevModeCheckFrequency, type DevModeChecks, type DevModeChecksExecutionInfo, type EqualityFn, type ExtractMemoizerFields, type GetParamsFromSelectors, type GetStateFromSelectors, type LruMemoizeOptions, type MemoizeOptionsFromParameters, type OutputSelector, type OutputSelectorFields, type OverrideMemoizeOptions, type RootStateSelectors, type Selector, type SelectorArray, type SelectorResultArray, type SelectorResultsMap, type SelectorsObject, type StructuredSelectorCreator, type TypedStructuredSelectorCreator, type UnknownMemoizer, type WeakMapMemoizeOptions, createSelector, createSelectorCreator, createStructuredSelector, lruMemoize, referenceEqualityCheck, setGlobalDevModeChecks, autotrackMemoize as unstable_autotrackMemoize, weakMapMemoize };
=======
