...
//#region src/compat/object/mapValues.d.ts
=======
import { ArrayIterator } from '../_internal/ArrayIterator.js';
import { ObjectIterator } from '../_internal/ObjectIterator.js';
import { StringIterator } from '../_internal/StringIterator.js';
 ...
 */
<<<<<<< HEAD
declare function mapValues<T extends object, U>(obj: T | null | undefined, callback: ObjectIterator<T, U>): { [P in keyof T]: U };
=======
 ...
 */
<<<<<<< HEAD
declare function mapValues<T extends object>(obj: T | null | undefined, iteratee: object): { [P in keyof T]: boolean };
=======
 ...
 */
<<<<<<< HEAD
declare function mapValues<T extends object>(obj: T | null | undefined, iteratee: string): { [P in keyof T]: any };
=======
