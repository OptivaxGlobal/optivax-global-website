 ...
 * untouched.
 */
type IntrinsicProps<T extends keyof React.JSX.IntrinsicElements> = IntrinsicElementsHaveDataIndex extends true ? WithCSSVarsForDataIndex<React.JSX.IntrinsicElements[T]> : WithCSSVars<React.JSX.IntrinsicElements[T]>;
/**
 ...
 */
<<<<<<< HEAD
export interface PolymorphicComponent<out R extends Runtime, in out BaseProps extends BaseObject> extends React.ForwardRefExoticComponent<FastOmit<BaseProps, 'as' | 'forwardedAs'> & {
...
export type Substitute<A extends BaseObject, B> = keyof B extends never ? {} extends B ? A : Substituted<A, B> : Substituted<A, B>;
/**
 ...
 */
export type MergeProps<A extends BaseObject, B> = keyof B extends never ? {} extends B ? A : Merged<A, B> : Merged<A, B>;
 ...
 */
export type MakeAttrsOptional<P extends BaseObject, K extends keyof any> = [K] extends [never] ? P : P extends unknown ? Omit<P, K & keyof P> & Partial<Pick<P, K & keyof P>> : never;
=======
/**
