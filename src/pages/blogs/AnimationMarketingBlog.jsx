...
const AnimationMarketingBlog = () => {
  return (
    <BlogArticleLayout
      ...
      metaTitle="The Importance of Animation in Digital Growth - Optivax Global"
      metaDescription="Learn how animation helps businesses capture attention, explain complex ideas, improve brand storytelling, increase engagement, and strengthen digital growth performance."
      canonicalUrl="https://optivaxglobal.com/important-of-animation-in-digital-marketing"
      category="Animation"
      date="June 2026"
      image={animationBlogImg}
      imageAlt="Animation in digital growth blog by Optivax Global"
      sections={sections}
    />
  );
};
