...
const SearchEngineMarketing = () => {
  const features = [
    ...
    { icon: <LineChart size={24} />, title: "Performance Tracking", text: "Your search strategy is structured with clear tracking so performance is easy to review." },
  ...
  const contentSections = [
    ...
    {
      title: "Coordinated Search Presence",
      text: "When search ads and on-site content work together, your business can appear more consistently and present a clearer message to visitors.",
    },
    {
      title: "A Search Strategy You Can Review",
      text: "Your search strategy should be easy to evaluate. We help you track what's working so you can adjust your approach over time.",
    },
  ];

  return (
    <ServiceTemplate
      pageTitle="Search Visibility & Digital Marketing Services in Wyoming USA - Optivax Global"
