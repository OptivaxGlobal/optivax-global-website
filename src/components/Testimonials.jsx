...
const testimonials = [
  ...
  },
  {
    ...
    role: 'Business Owner',
    content:
      'From Logo & Branding to website layout, everything was handled professionally. The team understood our vision and turned it into a clean digital brand.',
    avatar:
...
const Testimonials = () => {
  ...
  useEffect(() => {
    const updateItemsPerPage = () => {
      setItemsPerPage(window.innerWidth >= 1024 ? 3 : window.innerWidth >= 768 ? 2 : 1);
    };
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap justify-between items-end gap-8 mb-14">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 mt-5 leading-relaxed">
              Businesses choose Optivax Global for professional design, clear strategy,
              reliable delivery, and digital solutions built to support growth.
            </p>
          </div>
          ...
          <div className="hidden md:flex gap-4">
            <button
              ...
              className="p-3 rounded-full bg-[#1E1E2A] border border-white/10 text-white hover:bg-accent-purple/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        >
          {testimonials.map((testimonial) => (
            ...
            >
              <div className="bg-[#1E1E2A] p-8 rounded-3xl h-full flex flex-col border border-white/10 hover:border-accent-purple/40 transition-colors">
        ...
        <div className="mt-8 flex justify-end md:hidden">
          <div className="flex gap-4">
            <button
              onClick={() => scroll('left')}
              disabled={!canScrollLeft}
              className="p-3 rounded-full bg-[#1E1E2A] border border-white/10 text-white disabled:opacity-50"
              aria-label="Previous testimonial"
            >
              <ArrowLeft className="w-5 h-5" />
            </button>
